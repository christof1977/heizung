...
from resources.status import Status, Alive, HelpJsonCommands, HelpApi, FfIsTemp, FfSetTemp, Mixer, Sensor, SubscribedMqttTopics
...
api.add_resource(Sensor, '/status/sensor', resource_class_kwargs={'steuerung': steuerung})
api.add_resource(SubscribedMqttTopics, '/status/mqtt/subscribed', resource_class_kwargs={'steuerung': steuerung})
